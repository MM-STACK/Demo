            ...
            <div className="Main-Details-Pane">
                <div className="Main-Details-Card">
                    ...
                    <div className="Main-Details-Text">
                        ...
                        <br></br>
                        <br></br>
                        <p>This is a simple <b>ReactJS App</b> hosted on <b>AWS EC2</b> with <b>NGINX</b> web server. </p>                        
                        <p>Please click on "Applications" tab above to see list of web applications I have built to demonstrate concepts and patterns in coding web applications.</p>
                        <p>This website is my sandbox to improve skills as a Developer and also to practice AWS.</p>
                    </div>
                </div>
                ...
                <div className="Main-Details-Card">
                    ...
                    <div className="Main-Details-Text">
                        NodeJS, ExpressJS, ReactJS, JavaScript, AWS, Restful API, JQuery, RDBMS, SQL
                        <br></br>
                        Currently Learning: AWS, Lambda, GraphQL, Python
                        <br></br>
                        <br></br>
                        As much as I like JavaScript and Javascript based Libraries/frameworks. My new found interest is Amazon Web Services. 
                        My favorite AWS service is Cloudformation aka Infrastructure as code and being a developer I am excited to explore AWS Serverless services such as Amazon API Gateway, AWS Lambda, Amazon DynamoDB (NoSql) and AWS Step functions to orchestrate CI/CD.
